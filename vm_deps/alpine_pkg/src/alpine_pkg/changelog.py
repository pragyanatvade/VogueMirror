"""
Processes changelogs so that they can be used in binary packaging.
"""
...
0.1.26 (2012-12-26)
-------------------
* Utilizes caching to improve query performance (fix https://github.com/foo/ros_comm/pull/2)
...
def get_changelog_from_path(path, project_name=None):
    """
...
class Changelog(object):
    ...
    def __unicode__(self):
        ...
        if self.__project_name:
            msg.append("Changelog for project '{0}'".format(self.project_name))
...
class InvalidSectionTitle(Exception):
    """raised on not valid section titles"""
