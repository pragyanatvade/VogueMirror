# the CMake variable PYTHON_INSTALL_DIR has the same value as the Python function alpine.builder.get_python_install_dir()
...
if(SETUPTOOLS_DEB_LAYOUT)
  ...
  set(PYTHON_PROJECTS_DIR dist-packages)
  ...
  set(PYTHON_PROJECTS_DIR site-packages)
...
if(NOT WIN32)
  set(PYTHON_INSTALL_DIR lib/python${_PYTHON_PATH_VERSION_SUFFIX}/${PYTHON_PROJECTS_DIR}
  ...
  set(PYTHON_INSTALL_DIR lib/${PYTHON_PROJECTS_DIR}
    CACHE INTERNAL "This needs to be in PYTHONPATH when 'setup.py install' is called.  And it needs to match.  But setuptools won't tell us where it will install things.")
endif()
