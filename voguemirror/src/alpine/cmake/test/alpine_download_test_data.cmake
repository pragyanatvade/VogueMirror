_generate_function_if_testing_is_disabled("alpine_download_test_data")
...
#
# @public
function(alpine_download_test_data target url)
  _warn_if_skip_testing("alpine_download_test_data")

  cmake_parse_arguments(ARG "" "DESTINATION;FILENAME;MD5" "" ${ARGN})
  if(ARG_UNPARSED_ARGUMENTS)
    message(FATAL_ERROR "alpine_download_test_data() called with unused arguments: ${ARG_UNPARSED_ARGUMENTS}")
  endif()
  ...
  add_custom_command(OUTPUT ${output}
    COMMAND ${PYTHON_EXECUTABLE} ${alpine_EXTRAS_DIR}/test/download_checkmd5.py ${url} ${output} ${ARG_MD5}
    VERBATIM)
