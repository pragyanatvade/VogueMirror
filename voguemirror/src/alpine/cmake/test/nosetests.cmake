_generate_function_if_testing_is_disabled("alpine_add_nosetests")
...
# @public
#
function(alpine_add_nosetests path)
  _warn_if_skip_testing("alpine_add_nosetests")
  ...
  if("$ENV{ALPINE_TEST_COVERAGE}" STREQUAL "1")
  ...
  set(output_path ${ALPINE_TEST_RESULTS_DIR}/${PROJECT_NAME})
  ...
  alpine_run_tests_target("nosetests" ${output_file_name} "nosetests-${output_file_name}.xml" COMMAND ${cmd} DEPENDENCIES ${_nose_DEPENDENCIES} WORKING_DIRECTORY ${_nose_WORKING_DIRECTORY})
endfunction()

function(add_nosetests)
  message(WARNING "add_nosetests() is deprecated, please rename the function call to alpine_add_nosetests()")
  alpine_add_nosetests(${ARGN})
endfunction()
