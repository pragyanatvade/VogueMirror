...
try:
    import alpine.environment_cache
    from alpine.environment_cache import _append_header, _set_variable, _append_comment, _is_not_windows, generate_environment_script
...
class PlatformTest(unittest.TestCase):
    ...
    def setUp(self):
        self.platform_backup = alpine.environment_cache.platform
        self.winplatform = Mock()
        self.winplatform.system.return_value = 'Windows'
        linuxplatform = Mock()
        linuxplatform.system.return_value = 'Linux'
        alpine.environment_cache.platform = linuxplatform

    def tearDown(self):
        alpine.environment_cache.platform = self.platform_backup
    ...
    def test_generate_environment_script(self):
        try:
            ...
            alpine.environment_cache.os.environ = fake_environ
...
exec "$@"''')
            ...
            alpine.environment_cache.os.environ = os.environ
