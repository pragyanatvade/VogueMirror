...
class InterrogateSetupTest(unittest.TestCase):
    ...
    def test_generate_cmake_file(self):
        cmake_lines = (generate_cmake_file(project_name='pack1',
                                           version='0.0.1',
                                           scripts=[],
                                           package_dir={'': 'foopath'},
        ...
        self.assertEqual(['set(pack1_SETUP_PY_VERSION "0.0.1")',
                          ...
                          'set(pack1_SETUP_PY_PROJECTS "foo;bar")',
                          'set(pack1_SETUP_PY_PROJECT_DIRS "foopath/foo;foopath/bar")',
        ...
        self.assertEqual(['set(pack1_SETUP_PY_VERSION "0.0.1")',
                          'set(pack1_SETUP_PY_SCRIPTS "")',
                          'set(pack1_SETUP_PY_PROJECTS "foo;bar")',
                          'set(pack1_SETUP_PY_PROJECT_DIRS "foo;bar")',
                          'set(pack1_SETUP_PY_MODULES "")',
                          'set(pack1_SETUP_PY_MODULE_DIRS "")'],
                         cmake_lines)
        cmake_lines = (generate_cmake_file(project_name='pack1',
    ...
    def test_generate_cmake_file_noallprefix(self):
        ...
        self.assertEqual(['set(pack1_SETUP_PY_VERSION "0.0.1")',
                          'set(pack1_SETUP_PY_SCRIPTS "")',
                          'set(pack1_SETUP_PY_PROJECTS "foo;bar")',
                          'set(pack1_SETUP_PY_PROJECT_DIRS "src/foo;lib/bar")',
                          'set(pack1_SETUP_PY_MODULES "")',
                          'set(pack1_SETUP_PY_MODULE_DIRS "")'],
                         cmake_lines)
    ...
    def test_generate_cmake_file_msg_srv(self):
        ...
        self.assertEqual(['set(pack1_SETUP_PY_VERSION "0.0.1")',
                          'set(pack1_SETUP_PY_SCRIPTS "")',
                          'set(pack1_SETUP_PY_PROJECTS "foo")',
                          'set(pack1_SETUP_PY_PROJECT_DIRS "src/foo")',
                          'set(pack1_SETUP_PY_MODULES "")',
                          'set(pack1_SETUP_PY_MODULE_DIRS "")'],
                         cmake_lines)
...
set(foo_SETUP_PY_PROJECTS "")
set(foo_SETUP_PY_PROJECT_DIRS "")
...
set(foo_SETUP_PY_PROJECTS "foo;bar")
set(foo_SETUP_PY_PROJECT_DIRS "foo;bar")
set(foo_SETUP_PY_MODULES "")
set(foo_SETUP_PY_MODULE_DIRS "")""", contents)
            os.remove(outfile)
...
set(foo_SETUP_PY_SCRIPTS "")
set(foo_SETUP_PY_PROJECTS "foo;bar")
set(foo_SETUP_PY_PROJECT_DIRS "src/foo;lib/bar")
set(foo_SETUP_PY_MODULES "")
set(foo_SETUP_PY_MODULE_DIRS "")""", contents)
            os.remove(outfile)
        finally:
