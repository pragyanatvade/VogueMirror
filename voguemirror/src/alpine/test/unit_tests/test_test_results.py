...
try:
    ...
    import alpine.test_results as alpine_test_results
...
class TestResultsTest(unittest.TestCase):
    ...
    def test_read_junit(self):
        try:
            ...
            (num_tests, num_errors, num_failures) = alpine_test_results.read_junit(result_file)
    ...
    def test_test_results(self):
        try:
            ...
            for filename in ['test1.xml', 'test2.xml', 'foo.bar']:
                ...
                with open(result_file, 'w') as fhand:
                    fhand.write('<testsuites tests="5" failures="3" errors="1" time="35" name="AllTests"></testsuites>')
            results = alpine_test_results.test_results(rootdir)
    ...
    def test_print_summary(self):
        ...
        try:
            ...
            sys.stdout = StringIO()
            alpine_test_results.print_summary(results)
