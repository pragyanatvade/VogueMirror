#ifndef VM_SCANNER_SCANNER_HPP
#define VM_SCANNER_SCANNER_HPP
...
namespace vm
{
  namespace scanner
  {
    ...
    {
      static ScannerParams default_params();
    ...
    {
    public:
      typedef cv::Ptr<Scanner> Ptr;
      
      Scanner(const ScannerParams& params);

      const ScannerParams& params() const;
